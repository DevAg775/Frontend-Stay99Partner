    ...
    <aside className="shrink-0 bg-white border-r border-neutral-200 flex flex-col p-6 w-60 min-h-screen">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col leading-none">
          <span className="font-bold text-base text-neutral-900">PropVerify</span>
          <span className="text-[11px] text-neutral-400 leading-4">Admin</span>
        </div>
      </div>

      {/* Admin identity */}
      <div className="flex mt-8 items-center gap-3 bg-neutral-100 rounded-xl px-3 py-3">
        <div className="size-10 shrink-0 rounded-full bg-neutral-900 flex items-center justify-center text-sm font-semibold text-white">
          {initials}
        </div>
        <div className="flex flex-col min-w-0">
          ...
          <span className="text-xs leading-4 text-neutral-500">Administrator</span>
        </div>
      </div>
