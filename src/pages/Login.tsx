        ...
        <div className="flex w-285 h-239 overflow-hidden">
          ...
          <div className="w-[45%] bg-white flex p-12 justify-center items-center">
            <div className="max-w-sm flex flex-col gap-8 w-full">
              ...
              <Button
                variant="outline"
                className="font-medium rounded-lg bg-white text-neutral-950 border-neutral-200 border-0 border-solid gap-2 w-full h-11"
              >
                <svg className="size-4" viewBox="0 0 48 48">
                  <path
                    fill="#FFC107"
                    d="M43.6 20.5H42V20H24v8h11.3C33.7 32.4 29.3 35 24 35c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.6 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5 43.5 34.8 43.5 24c0-1.2-.1-2.3-.4-3.5z"
                  />
                  <path
                    fill="#FF3D00"
                    d="M6.3 14.7l6.6 4.8C14.7 15.1 19 12 24 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.6 4.5 24 4.5c-7.7 0-14.3 4.4-17.7 10.2z"
                  />
                  <path
                    fill="#4CAF50"
                    d="M24 43.5c5.5 0 10.3-1.9 13.8-5.1l-6.4-5.2c-2 1.4-4.6 2.3-7.4 2.3-5.3 0-9.7-3.5-11.3-8.4l-6.5 5C9.4 39 16.1 43.5 24 43.5z"
                  />
                  <path
                    fill="#1976D2"
                    d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.4l6.4 5.2C41.5 35.5 43.5 30.2 43.5 24c0-1.2-.1-2.3-.4-3.5z"
                  />
                </svg>
